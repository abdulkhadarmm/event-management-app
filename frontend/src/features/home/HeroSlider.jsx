...
/**
 * Modern Full-Screen Hero Slider featuring original clean typography overlay,
 * zero card boxes, full-screen background video, and bold pill CTAs.
 */
  ...
  return (
    ...
    >
          ...
          >
            ...
            <div
              style={{
                ...
                inset: 0,
                background:
                  'linear-gradient(to right, rgba(255, 255, 255, 0.94) 0%, rgba(255, 255, 255, 0.85) 45%, rgba(255, 255, 255, 0.3) 75%, transparent 100%)',
              }}
            />
      ...
      >
        ...
        <div key={`slide-content-${slideIndex}`} style={{ maxWidth: '680px', paddingTop: '96px', width: '100%' }}>
